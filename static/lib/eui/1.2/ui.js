/*! eUI - v1.0.0 */;(function ($) {
    ...
    window.eui = window.UI = window.ui = UI;
...
(function ($) {
    ...
    fn.init = function (elem, option) {
        ...
        that.hander.on('mousedown', function (e) {
...
;;(function ($) {
    ...
    Dialog.pt.vessel = function (conType, callback) {
        ...
        var dialogHtml =
            ...
            '<div class="dialog ' + opts.anim + (' dialog-' + Dialog._type[opts.type])
